...
static const attribute_template_t ATTRIBUTE_TABLE[] = 
{
    ...
    {CKA_VERIFY,            "verify",               PKCS11_BOOL},
    {CKA_ENCRYPT,           "encrypt",              PKCS11_BOOL},
    {CKA_DECRYPT,           "decrypt",              PKCS11_BOOL},
    {CKA_DERIVE,            "derive",               PKCS11_BOOL},
    {CKA_WRAP,              "wrap",                 PKCS11_BOOL},
    {CKA_UNWRAP,            "unwrap",               PKCS11_BOOL},
